# -*- coding: utf-8 -*-
"""
Created on Sat Apr  2 23:14:19 2022

Adapted from AIX360.
To be used for GP global explainers
...
# class GPRuleRegression(BaseEstimator, ClassifierMixin):
...
#     def predict(self, X, Xstd=None):
#         """Predict responses, std of each prediction and covariance .
#         Args:
#             X (DataFrame): Binarized features with MultiIndex column labels
#             Xstd (DataFrame, optional): Standardized numerical features
#         Returns:
#             array: yhat -- Predicted response
#             array: y_std 
#             array: y_cov
#         """
#         try:
